...
def get_signal(auth_val, asset_id, device_id, is_apikey=False):
    url = f"https://api.mocreo.com/v1/assets/{asset_id}/devices/{device_id}/signal"
...
if __name__ == "__main__":
    ...
    get_signal(args.auth, args.asset_id, args.device_id, args.apikey)
